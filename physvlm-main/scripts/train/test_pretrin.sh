...
STAGE1_TRAIN_ANNOTATION_PATH=/data/zhouweijie/physvlm_back/physvlm-main/tmp_train.json
STAGE1_TRAIN_DATA_IMAGE_FOLDER=/data/zhouweijie/physvlm_back/pybullet-URDF-models-main
STAGE1_OUTPUT_DIR=/data/zhouweijie/physvlm_back/physvlm-main/checkpoints/physvlm-qwen2-0.5B-pretrain
