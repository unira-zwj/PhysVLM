...
def train(attn_implementation=None):
    ...
    if not model.config.freeze_depth_encoder:
        ...
        model.get_depth_tower().requires_grad_(False)
    ...
    if not model.config.freeze_depth_mlp:
        ...
        model.get_model().mm_depth_projector.requires_grad_(True)
    else:
        model.get_model().mm_depth_projector.requires_grad_(False)
